...
parser.add_argument("--base", "-b", help="base currency")

parser.add_argument("--target", "-t", help="target currency")

parser.add_argument("--amount", "-a", type=float, help="amount to convert")

parser.add_argument(
    "--mock", "-m", help="use mock data for testing", action="store_true"
)
